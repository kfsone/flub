      ...
      switch (yyr1_[yyn])
    {
      ...
      try
#endif // YY_EXCEPTIONS
        {
          switch (yyn)
            {
  case 4: // commands: command
#line 82 "parser.y"
                {	std::cout << "1| " << yystack_[0].value.as < std::string > () << "\n"; }
#line 683 "parser.cc"
    break;

  case 5: // commands: command commands
#line 84 "parser.y"
                {	std::cout << "2| " << yystack_[1].value.as < std::string > () << "\n"; }
#line 689 "parser.cc"
    break;
