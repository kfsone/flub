...
switch (yykind)
    ...
    struct symbol_type : basic_symbol<by_kind>
    {
...
#endif
      {
        ...
        YY_ASSERT (tok == token::YYEOF
                   || (token::YYerror <= tok && tok <= token::IGNORE));
#endif
      }
#if 201103L <= YY_CPLUSPLUS
    ...
    Parser (Flub::Scanner& scanner_yyarg, Flub::Driver& driver_yyarg);
    virtual ~Parser ();
    ...
    // Implementation of make_symbol for each token kind.
      ...
      {
        return symbol_type (token::IGNORE, std::move (l));
      }
#else
      static
      symbol_type
